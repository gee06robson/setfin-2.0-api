...
var AuthenticateUserService = /** @class */ (function () {
    ...
    AuthenticateUserService.prototype.execute = function (credential) {
        return __awaiter(this, void 0, void 0, function () {
            var client, ticket, _a, name, email, sub, picture, user, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ticket = _b.sent();
                        _a = ticket.getPayload(), name = _a.name, email = _a.email, sub = _a.sub, picture = _a.picture;
